...
const Scan = () => {
  ...
  return (
    <Container maxWidth="lg" sx={{ height: `max(100%, 100vh)` }}>
      <Typography variant="h6" className="theme-title__typography--primary" sx={{mb: '35px', fontFamily: 'var(--primary-font)', color: `${theme.palette['--theme-font-color__tertiary'][theme.palette.mode]} !important`}}>Report Generation </Typography>
